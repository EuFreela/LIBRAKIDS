    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                Número de acertos: 
                <span class="badge badge-pill badge-success" style="color:white;">{{ DB::table('history')->where('status_choice','=','ACERTOU')->Count() }}</span>
                Número de erros: 
                <span class="badge badge-pill badge-danger" style="color:white;">{{ DB::table('history')->where('status_choice','=','ERROU')->Count() }}</span>
                </div>
